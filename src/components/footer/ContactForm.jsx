      ...
      <div className="container px-5 py-5 mx-auto flex flex-wrap justify-center ">
        ...
        {state.succeeded ? (
          <div className="lg:w-1/3 md:w-1/2  p-6 flex flex-col md:ml-auto mt-20 md:mt-0 relative z-10  w-full md:w-auto">
            ...
            <p className="text-gray-900 text-lg mb-1 mt-6 text-center text-gray-300 font-medium title-font">
            ...
            <form onSubmit={handleSubmit}>
              <div className="relative mb-4">
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full bg-white dark:bg-slate-700 rounded border border-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
                <ValidationError
                  prefix="name"
                  field="name"
              ...
              <div className="relative mb-4">
                ...
                <textarea
                  id="message"
                  name="message"
                  className="w-full bg-white dark:bg-slate-700 rounded border border-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                ></textarea>
              </div>
